...
// const FilterControls = ({ onDayChange, onShowClick }) => {
...
//       </select>
//       <select onChange={(e) => setSelectedWireless(e.target.value)}>
...
//   const [selectedDay, setSelectedDay] = useState('Today');
//   const [selectedWireless, setSelectedWireless] = useState('Option1');
//   const [isDropdownVisible, setIsDropdownVisible] = useState(true); // Added state for dropdown visibility
